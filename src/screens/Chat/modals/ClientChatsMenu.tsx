...
import { useDeleteClient } from '../hooks/useFetchDeleteChats';
...
const ClientChatsMenu: React.FC<IProps> = ({ closeModal, navigation }) => {
  ...
  return (
    <View
      ...
      <View
        ...
        {button('Отключить уведомления', false, () => closeModal())}
        {button('Позвонить клиенту', false, () => () => closeModal())}
        {button('Удалить чат', true, () => fetch(selectedClient))}
      </View>
      <TouchableOpacity
        style={{
...
export default ClientChatsMenu;
