...
const DeleteClientsModal: React.FC<IProps> = ({ closeModal, data, status, labelText, onPress }) => {
    ...
    <View
      ...
      <View
        ...
        <Text
          ...
          <Text style={{ fontFamily: FONTFAMILY.text.semibold, textTransform: 'capitalize' }}>
            {data.name ? ' ' + data.name : ''}
          </Text>
          <Text style={{ fontFamily: FONTFAMILY.text.semibold, textTransform: 'capitalize' }}>
